...
@TeleOp
@Disabled
public class ControllerOpModeOne extends LinearOpMode {
    //defining our two motors
    /*private DcMotor motorL;
    private DcMotor motorR;
    private DcMotor omnimotorL;
    private DcMotor omnimotorR;*/
    ...
    public void runOpMode() {
        ...
        omnimotorL = hardwareMap.get(DcMotor.class, "omnimotorL");
        omnimotorR = hardwareMap.get(DcMotor.class, "omnimotorR");*/
        ...
        while (opModeIsActive()) {
            ...
            /*
            servoCGo = this.gamepad1.right_trigger>0.5;
            if (servoCGo) {
            ...
            servoCReverse = this.gamepad1.right_bumper;
            if (servoCReverse) {
                servoCL.setPosition(servoCL.getPosition() + .25);
                servoCR.setPosition(servoCR.getPosition() - .25);
            }*/
